...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [aux_sym_datoteka_repeat1] = STATE(80),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_datoteka_repeat1, 2),
  [235] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_datoteka_repeat1, 2), SHIFT_REPEAT(274),
  [238] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_datoteka_repeat1, 2), SHIFT_REPEAT(79),
  [241] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_datoteka_repeat1, 2), SHIFT_REPEAT(138),
  [244] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_datoteka_repeat1, 2), SHIFT_REPEAT(142),
  [247] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_datoteka_repeat1, 2), SHIFT_REPEAT(255),
  [250] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_datoteka_repeat1, 2), SHIFT_REPEAT(261),
  [253] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_datoteka_repeat1, 2), SHIFT_REPEAT(193),
  [256] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_datoteka_repeat1, 2), SHIFT_REPEAT(171),
  [259] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_datoteka_repeat1, 2), SHIFT_REPEAT(174),
  [262] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_datoteka_repeat1, 2), SHIFT_REPEAT(193),
  [265] = {.entry = {.count = 1, .reusable = true}}, SHIFT(201),
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_datoteka, 1),
